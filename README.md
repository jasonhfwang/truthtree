...
- One of the really interesting things about truth tree is that you can basically verify sub-trees and those influence the larger trees, so it's kind of like algorithmically breaking apart knowledge and debate, and that's really powerful! I've never seen that before, and I think that's appropriate in the era of LLMs and agents because you can basically flesh out sub-trees without having to deal with everything. It's partial. It doesn't have to be complete in order to be valuable, and that's verifiable. So nice!
